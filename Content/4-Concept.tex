...
\section{Problem Statement and Goals}\todo{maybe create new chapter?}
...
First, the conceptual steps the central controller manager needs to do in order to establish connection are explained:\todo{Add CommandForwarder Statepublisher}
\begin{enumerate}
...
On the other hand, the sub-controller manager needs to perform the following tasks during the registration process:
\begin{enumerate}
